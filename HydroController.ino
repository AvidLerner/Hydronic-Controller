    ...
    ******************************************************************
    ** Revised for current lcd 11/11/16 Avidlerner********************
    ******************************************************************
    ...
    */
    ...
    #include <URTouch.h>            //Touchscreen library
    #include <SD.h>                 //SD card library
    #include <Wire.h>               //One Wire library
    //#include <RTClib.h>             //Real Time Clock library
    #include <EEPROMex.h>           //Extended Eeprom library
    #include <SPI.h>                // Serial Protocal library
    #include <DS3231.h>             // DS3231 RTC library device
    ...
    #define dht_dpin 15                // pin for DHT11 A15
    ...
    int sc,mn,hr,dy,mnth,yr; // DS3231 RTC 
    bool Century = false;              // RTC functions
    bool h12 = false;                  // 24 hour clock time
    bool PM = false;                   // am/pm false
    extern uint8_t BigFont[];          //Which fonts to use...
    extern uint8_t SmallFont[];
    extern uint8_t SevenSegNumFont[];

             
     DS3231 Clock;                      // setup[ ds3231  Real Time Clock using i2c address direct
    ...
    byte dht_dat[4];    //Array to hold the bytes sent from sensor.
        ...
        Serial.begin(9600);
        delay(300);
        Serial.println("Air Humidity, temperature & pH");
